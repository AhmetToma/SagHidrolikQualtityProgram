...
$(Inputs.newNC_ncType).select2()
    .on("select2:select", function (e) {
        ...
        newNcModel.ncType = parseInt(select_val[0]);
...
$(Inputs.newNC_cutomerSup).select2()
    .on("select2:select", function (e) {
        let selected_element = $(e.currentTarget);
        let select_val = selected_element.val();
        newNcModel.customerSupplier = parseInt(select_val[0]);
...
$(Inputs.newNC_dep).select2()
    .on("select2:select", function (e) {
        let selected_element = $(e.currentTarget);
        let select_val = selected_element.val();
        newNcModel.department = parseInt(select_val[0]);
...
$(Inputs.newNC_process).select2()
    .on("select2:select", function (e) {
        let selected_element = $(e.currentTarget);
        let select_val = selected_element.val();
        newNcModel.process = parseInt(select_val[0]);
    });
...
$(Inputs.newNC_partNo).select2()
    .on("select2:select", function (e) {
        let selected_element = $(e.currentTarget);
        let select_val = selected_element.val();
        newNcModel.partNo = parseInt(select_val[0]);
    });
...
$(Inputs.newNC_openBy).select2()
    .on("select2:select", function (e) {
        let selected_element = $(e.currentTarget);
        let select_val = selected_element.val();
        newNcModel.openBy = parseInt(select_val[0]);
    });
...
$(Inputs.newNC_resposible).select2()
    .on("select2:select", function (e) {
        let selected_element = $(e.currentTarget);
        let select_val = selected_element.val();
        newNcModel.responsible = parseInt(select_val[0]);
    });
...
$(Buttons.newNc_submit).click((event) => {
    ...
    newNcModel.qty = parseInt($(Inputs.newNC_qty).val());
